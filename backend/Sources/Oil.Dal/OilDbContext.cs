...
namespace Oil.Dal
{
    public class OilDbContext: IdentityDbContext<ApplicationUser>
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            var well2 = new Well { Id = 2, FieldId = field1.Id, Name = "100Р", CompanyId = company1.Id, ShopId = shop3.Id, Altitude = 10, ZabI = 1988, ZabF = 2002, WellTypeId = wellType2.Id };
            //var well3 = new Well { Id = 3, FieldId = field2.Id, Name = "101Р", CompanyId = company1.Id, ShopId = shop4.Id };
            //var well4 = new Well { Id = 4, FieldId = field4.Id, Name = "1В", CompanyId = company2.Id, ShopId = shop1.Id };
            //var well5 = new Well { Id = 5, FieldId = field4.Id, Name = "456", CompanyId = company2.Id, ShopId = shop2.Id };
            //var well6 = new Well { Id = 6, FieldId = field5.Id, Name = "111", CompanyId = company2.Id, ShopId = shop1.Id };
            //var well7 = new Well { Id = 7, FieldId = field5.Id, Name = "20089", CompanyId = company2.Id, ShopId = shop1.Id };
            //var well8 = new Well { Id = 8, FieldId = field6.Id, Name = "49", CompanyId = company2.Id, ShopId = shop2.Id };
            //var well9 = new Well { Id = 9, FieldId = field7.Id, Name = "1011", CompanyId = company4.Id, ShopId = shop6.Id };
            //var well10 = new Well { Id = 10, FieldId = field8.Id, Name = "2345", CompanyId = company4.Id, ShopId = shop6.Id };
            //var well11 = new Well { Id = 11, FieldId = field8.Id, Name = "99Н", CompanyId = company4.Id, ShopId = shop6.Id };

            modelBuilder.Entity<Well>().HasData(well1, well2);
